...
class AOS_Quotes extends AOS_Quotes_sugar
{
    ...
    public function create_export_query($order_by, $where, $relate_link_join='')
    {
        ...
        if($relate_link_join != 'ForExportSample'){
            $parts=explode(' FROM aos_quotes',$query);
            $parts[0]=$parts[0].','."
            (SELECT 
            ...
            WHERE
                aos_quotes_cb2b_hotels_1_c.deleted = 0
                    AND aos_quotes_cb2b_hotels_1_c.aos_quotes_cb2b_hotels_1aos_quotes_ida = aos_quotes.id
            GROUP BY aos_quotes_cb2b_hotels_1aos_quotes_ida) as associate_hotels_quotes ";
            $query=$parts[0].' FROM aos_quotes'.$parts[1];
            $relate_link_join = '';
        }
