    ...
    public function displayTMCE()
    {
		...
		var df = '{$locale->getPrecedentPreference('default_date_format')}';
 		...
 		tinyMCE.init({
			...
			theme_advanced_fonts:"columbiasansw-extralight=Columbia Sans W ExtraLight;Inter-SemiBold=Inter Semi Bold;Inter-Light=Inter Light;columbiasansw-light=Columbia Sans W Light;columbiasans-light=Columbia Sans Light;Inter-Medium=Inter Medium;Inter-ExtraLight=Inter ExtraLight;FS Emeric Medium=FS Emeric Medium;FS Emeric-Light=FS Emeric Light;FS Emeric-Regular=FS Emeric;FS Emeric-ExtraLight=FS Emeric ExtraLight;FS Emeric-Core=FS Emeric Core;Inter-Black=Inter Black;Inter-ExtraBold=Inter Extra Bold;Inter-Thin=Inter Thin;PitchSans-Regular=Pitch Sans;columbiasans-extralight=Columbia Sans ExtraLight;Emeric-ExtraBold=FS Emeric ExtraBold;Andale Mono=andale mono,times;Arial=arial,helvetica,sans-serif;Arial Black=arial black,avant garde;Book Antiqua=book antiqua,palatino;Comic Sans MS=comic sans ms,sans-serif;Courier New=courier new,courier;Georgia=georgia,palatino;Helvetica=helvetica;Helvetica Neu=helveticaneue,sans-serif;Impact=impact,chicago;Symbol=symbol;Tahoma=tahoma,arial,helvetica,sans-serif;Terminal=terminal,monaco;Times New Roman=times new roman,times;Trebuchet MS=trebuchet ms,geneva;Verdana=verdana,geneva;Webdings=webdings;Wingdings=wingdings,zapf dingbats",
