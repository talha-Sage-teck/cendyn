...
require_once __DIR__ . '/../../../../../../../public/legacy/include/MVC/View/views/view.popup.php';

class ViewPopupCustom extends ViewPopup
{
    ...
    public function display()
    {
        ...
        if (!empty($listViewDefs) && !empty($searchdefs)) {
            ...
            $popup->headerTpl = $this->getCustomFilePathIfExists("custom/include/Popups/tpls/popupHeader.tpl");
