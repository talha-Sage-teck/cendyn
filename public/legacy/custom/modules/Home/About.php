        ...
        <TR>
            <div style="font-size: 14px;color: #777777;margin-bottom: 10px;">
                ...
                <p>
                    ...
                    <br /><br />
                    Driven by the same PMS data that powers Cendyn B2C CRM, Cendyn B2B CRM enables hoteliers to easily correlate guest profile, reservation, and production data from the PMS with corporate accounts and travel agent data to determine where the demand lies, learn more about their feeder markets and pinpoint opportunities and gaps across their sales and marketing strategy. With hotels looking for every opportunity to drive profitability and provide operational efficiencies, Cendyn B2B CRM and Cendyn B2C CRM offers the unique opportunity to optimally manage all demand and their sales pipeline across transient and corporate business in one single platform.
                    <br /><br />
