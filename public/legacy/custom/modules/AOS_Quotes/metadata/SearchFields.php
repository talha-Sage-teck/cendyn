...
$searchFields['AOS_Quotes'] = array (
  ...
  array (
    ...
    'operator' => 'subquery',
    'subquery' => '
select aos_quotes_cb2b_hotels_1aos_quotes_ida from aos_quotes_cb2b_hotels_1_c join cb2b_hotels on cb2b_hotels.id=aos_quotes_cb2b_hotels_1_c.aos_quotes_cb2b_hotels_1cb2b_hotels_idb
and cb2b_hotels.deleted=0
where aos_quotes_cb2b_hotels_1_c.deleted=0 and cb2b_hotels.name in (\'{0}\')',
    0 => 'aos_quotes_cb2b_hotels_1',
  ),
);