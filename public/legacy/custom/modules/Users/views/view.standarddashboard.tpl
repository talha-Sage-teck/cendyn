                ...
                <div id="main" style='margin-bottom:5px; margin-top:5px' >
                    ...
                    <table class="themeSettings edit view" style='margin-bottom:0px; margin-top:5px' border="0" cellspacing="3" cellpadding="10">
                        ...
                        <tr style="padding-bottom: 10px!important;">
                            ...
                            <td valign="top" width="37.5%">
                                <select id="tabs" name="tabs[]" multiple size="5" style="width: 50%;height: 100%;border-color: #A5E8D6;border-style: double;"></select>
                            </td>
                        </tr>
                        <tr style="padding-bottom: 10px!important;">
                            <td valign="top" width="12.5%" scope="col">
                            ...
                            <td valign="top" width="37.5%">
                                <select id="users" name="users[]" multiple size="6" style="width: 50%;height: 100%;border-color: #A5E8D6;border-style: solid;"></select>
                            </td>
                        </tr>
                    </table>
                </div>
