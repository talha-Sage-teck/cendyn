(function () {
  ...
  (self["webpackChunkshell"] = self["webpackChunkshell"] || []).push([["node_modules_angular_common_fesm2015_common_js-_f1da0"], {
    /***/
    13412: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _DOCUMENT = /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_0__.InjectionToken('DocumentToken');
      /**
       * @license
       * Copyright Google LLC All Rights Reserved.
       *
      ...
      var _LOCATION_INITIALIZED = /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_0__.InjectionToken('Location Initialized');
      /**
      ...
      var _APP_BASE_HREF = /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_0__.InjectionToken('appBaseHref');
      /**
       * @description
      ...
      var _PathLocationStrategy = /*#__PURE__*/function () {
        ...
        PathLocationStrategy.ɵfac = function PathLocationStrategy_Factory(t) {
          return new (t || PathLocationStrategy)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_PlatformLocation), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_APP_BASE_HREF, 8));
        };
      ...
      var _HashLocationStrategy = /*#__PURE__*/function () {
        var HashLocationStrategy = /*#__PURE__*/function (_LocationStrategy3) {
          _inherits(HashLocationStrategy, _LocationStrategy3);
        ...
        HashLocationStrategy.ɵfac = function HashLocationStrategy_Factory(t) {
          return new (t || HashLocationStrategy)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_PlatformLocation), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_APP_BASE_HREF, 8));
        };
      ...
      var _Location = /*#__PURE__*/function () {
        ...
        Location.ɵfac = function Location_Factory(t) {
          return new (t || Location)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_LocationStrategy), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_PlatformLocation));
        };
        /**
         * Normalizes URL parameters by prepending with `?` if needed.
         *
      ...
      var _NumberFormatStyle = /*#__PURE__*/function () {
        _NumberFormatStyle = _NumberFormatStyle || {};
        _NumberFormatStyle[_NumberFormatStyle["Decimal"] = 0] = "Decimal";
        _NumberFormatStyle[_NumberFormatStyle["Percent"] = 1] = "Percent";
        _NumberFormatStyle[_NumberFormatStyle["Currency"] = 2] = "Currency";
        _NumberFormatStyle[_NumberFormatStyle["Scientific"] = 3] = "Scientific";
        return _NumberFormatStyle;
      }();
      /**
      ...
      var _Plural = /*#__PURE__*/function () {
        _Plural = _Plural || {};
        _Plural[_Plural["Zero"] = 0] = "Zero";
        _Plural[_Plural["One"] = 1] = "One";
        _Plural[_Plural["Two"] = 2] = "Two";
        _Plural[_Plural["Few"] = 3] = "Few";
        _Plural[_Plural["Many"] = 4] = "Many";
        _Plural[_Plural["Other"] = 5] = "Other";
        return _Plural;
      }();
      /**
      ...
      var _FormStyle = /*#__PURE__*/function () {
        _FormStyle = _FormStyle || {};
        _FormStyle[_FormStyle["Format"] = 0] = "Format";
        _FormStyle[_FormStyle["Standalone"] = 1] = "Standalone";
        return _FormStyle;
      }();
      /**
      ...
      var _TranslationWidth = /*#__PURE__*/function () {
        _TranslationWidth = _TranslationWidth || {};
        /** 1 character for `en-US`. For example: 'S' */

        _TranslationWidth[_TranslationWidth["Narrow"] = 0] = "Narrow";
        /** 3 characters for `en-US`. For example: 'Sun' */

        _TranslationWidth[_TranslationWidth["Abbreviated"] = 1] = "Abbreviated";
        /** Full length for `en-US`. For example: "Sunday" */

        _TranslationWidth[_TranslationWidth["Wide"] = 2] = "Wide";
        /** 2 characters for `en-US`, For example: "Su" */

        _TranslationWidth[_TranslationWidth["Short"] = 3] = "Short";
        return _TranslationWidth;
      }();
      /**
      ...
      var _FormatWidth = /*#__PURE__*/function () {
        ...
        _FormatWidth[_FormatWidth["Short"] = 0] = "Short";
        /**
         * For `en-US`, `'MMM d, y, h:mm:ss a'`
         * (Example: `Jun 15, 2015, 9:03:01 AM`)
         */

        _FormatWidth[_FormatWidth["Medium"] = 1] = "Medium";
        /**
         * For `en-US`, `'MMMM d, y, h:mm:ss a z'`
         * (Example: `June 15, 2015 at 9:03:01 AM GMT+1`)
         */

        _FormatWidth[_FormatWidth["Long"] = 2] = "Long";
        /**
         * For `en-US`, `'EEEE, MMMM d, y, h:mm:ss a zzzz'`
         * (Example: `Monday, June 15, 2015 at 9:03:01 AM GMT+01:00`)
         */

        _FormatWidth[_FormatWidth["Full"] = 3] = "Full";
        return _FormatWidth;
      }();
      /**
      ...
      var _NumberSymbol = /*#__PURE__*/function () {
        ...
        _NumberSymbol[_NumberSymbol["Decimal"] = 0] = "Decimal";
        /**
        ...
        _NumberSymbol[_NumberSymbol["Group"] = 1] = "Group";
        /**
         * List-item separator.
         * Example: "one, two, and three"
         */

        _NumberSymbol[_NumberSymbol["List"] = 2] = "List";
        /**
         * Sign for percentage (out of 100).
         * Example: 23.4%
         */

        _NumberSymbol[_NumberSymbol["PercentSign"] = 3] = "PercentSign";
        /**
         * Sign for positive numbers.
         * Example: +23
         */

        _NumberSymbol[_NumberSymbol["PlusSign"] = 4] = "PlusSign";
        /**
         * Sign for negative numbers.
         * Example: -23
         */

        _NumberSymbol[_NumberSymbol["MinusSign"] = 5] = "MinusSign";
        /**
         * Computer notation for exponential value (n times a power of 10).
         * Example: 1.2E3
         */

        _NumberSymbol[_NumberSymbol["Exponential"] = 6] = "Exponential";
        /**
         * Human-readable format of exponential.
         * Example: 1.2x103
         */

        _NumberSymbol[_NumberSymbol["SuperscriptingExponent"] = 7] = "SuperscriptingExponent";
        /**
         * Sign for permille (out of 1000).
         * Example: 23.4‰
         */

        _NumberSymbol[_NumberSymbol["PerMille"] = 8] = "PerMille";
        /**
         * Infinity, can be used with plus and minus.
         * Example: ∞, +∞, -∞
         */

        _NumberSymbol[_NumberSymbol["Infinity"] = 9] = "Infinity";
        /**
         * Not a number.
         * Example: NaN
         */

        _NumberSymbol[_NumberSymbol["NaN"] = 10] = "NaN";
        /**
         * Symbol used between time units.
         * Example: 10:52
         */

        _NumberSymbol[_NumberSymbol["TimeSeparator"] = 11] = "TimeSeparator";
        /**
         * Decimal separator for currency values (fallback to `Decimal`).
         * Example: $2,345.67
         */

        _NumberSymbol[_NumberSymbol["CurrencyDecimal"] = 12] = "CurrencyDecimal";
        /**
         * Group separator for currency values (fallback to `Group`).
         * Example: $2,345.67
         */

        _NumberSymbol[_NumberSymbol["CurrencyGroup"] = 13] = "CurrencyGroup";
      ...
      var _WeekDay = /*#__PURE__*/function () {
        _WeekDay = _WeekDay || {};
        _WeekDay[_WeekDay["Sunday"] = 0] = "Sunday";
        _WeekDay[_WeekDay["Monday"] = 1] = "Monday";
        _WeekDay[_WeekDay["Tuesday"] = 2] = "Tuesday";
        _WeekDay[_WeekDay["Wednesday"] = 3] = "Wednesday";
        _WeekDay[_WeekDay["Thursday"] = 4] = "Thursday";
        _WeekDay[_WeekDay["Friday"] = 5] = "Friday";
        _WeekDay[_WeekDay["Saturday"] = 6] = "Saturday";
        return _WeekDay;
      }();
      /**
      ...
      var _NgLocaleLocalization = /*#__PURE__*/function () {
        var NgLocaleLocalization = /*#__PURE__*/function (_NgLocalization2) {
          _inherits(NgLocaleLocalization, _NgLocalization2);
      ...
      var _NgForOfContext = /*#__PURE__*/function () {
        function _NgForOfContext($implicit, ngForOf, index, count) {
          _classCallCheck(this, _NgForOfContext);
            ...
            value: function _applyChanges(changes) {
              ...
              changes.forEachOperation(function (item, adjustedPreviousIndex, currentIndex) {
                if (item.previousIndex == null) {
                  ...
                  var view = _this12._viewContainer.createEmbeddedView(_this12._template, new _NgForOfContext(null, _this12._ngForOf, -1, -1), currentIndex === null ? undefined : currentIndex);
      ...
      var _NgSwitchDefault = /*#__PURE__*/function () {
      ...
      var _NgPlural = /*#__PURE__*/function () {
        ...
        NgPlural.ɵfac = function NgPlural_Factory(t) {
          return new (t || NgPlural)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_NgLocalization));
        };
      ...
      var _NgPluralCase = /*#__PURE__*/function () {
      ...
      var _I18nPluralPipe = /*#__PURE__*/function () {
        ...
        I18nPluralPipe.ɵfac = function I18nPluralPipe_Factory(t) {
          return new (t || I18nPluralPipe)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_NgLocalization, 16));
        };
      ...
      var _CommonModule = /*#__PURE__*/function () {
      ...
      var _ViewportScroller = /*#__PURE__*/function () {
...
//# sourceMappingURL=node_modules_angular_common_fesm2015_common_js-_f1da0-es5.898caea35eef891dde3d.js.map