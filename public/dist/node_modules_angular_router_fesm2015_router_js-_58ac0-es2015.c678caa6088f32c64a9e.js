"use strict";
(self["webpackChunkshell"] = self["webpackChunkshell"] || []).push([["node_modules_angular_router_fesm2015_router_js-_58ac0"],{
...
class ApplyRedirects {
  ...
  expandSegmentGroup(ngModule, routes, segmentGroup, outlet) {
    if (segmentGroup.segments.length === 0 && segmentGroup.hasChildren()) {
      return this.expandChildren(ngModule, routes, segmentGroup).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(children => new UrlSegmentGroup([], children)));
    }
  ...
  expandChildren(ngModule, routes, segmentGroup) {
    ...
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.from)(childOutlets).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.concatMap)(childOutlet => {
      ...
      return this.expandSegmentGroup(ngModule, sortedRoutes, child, childOutlet).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(s => ({
        segment: s,
        outlet: childOutlet
      })));
  ...
  getChildConfig(ngModule, route, segments) {
    ...
    if (route.loadChildren) {
      ...
      return this.runCanLoadGuards(ngModule.injector, route, segments).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.mergeMap)(shouldLoadResult => {
        if (shouldLoadResult) {
          return this.configLoader.load(ngModule.injector, route).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(cfg => {
            route._loadedConfig = cfg;
            return cfg;
          }));
        }
...
function applyRedirects$1(moduleInjector, configLoader, urlSerializer, config) {
  return (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.switchMap)(t => applyRedirects(moduleInjector, configLoader, urlSerializer, t.extractedUrl, config).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(urlAfterRedirects => Object.assign(Object.assign({}, t), {
    urlAfterRedirects
  }))));
}
/**
...
function checkGuards(moduleInjector, forwardEvent) {
  return (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.mergeMap)(t => {
    ...
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(guardsResult => Object.assign(Object.assign({}, t), {
      guardsResult
    })));
  });
}
...
function recognize$1(rootComponentType, config, serializer, paramsInheritanceStrategy, relativeLinkResolution) {
  return (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.mergeMap)(t => recognize(rootComponentType, config, t.urlAfterRedirects, serializer(t.urlAfterRedirects), paramsInheritanceStrategy, relativeLinkResolution).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(targetSnapshot => Object.assign(Object.assign({}, t), {
    targetSnapshot
  }))));
}
/**
...
function resolveNode(resolve, futureARS, futureRSS, moduleInjector) {
  ...
  const data = {};
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.from)(keys).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.mergeMap)(key => getResolver(resolve[key], futureARS, futureRSS, moduleInjector).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.tap)(value => {
    data[key] = value;
  }))), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.takeLast)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.mergeMap)(() => {
...
const ROUTES = /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_1__.InjectionToken('ROUTES');
...
class RouterConfigLoader {
  ...
  load(parentInjector, route) {
    ...
    const loadRunner = moduleFactory$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(factory => {
    ...
    route._loader$ = new rxjs__WEBPACK_IMPORTED_MODULE_2__.ConnectableObservable(loadRunner, () => new rxjs__WEBPACK_IMPORTED_MODULE_2__.Subject()).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.refCount)());
    return route._loader$;
  }
...
let Router = /*#__PURE__*/(() => {
  class Router {
    ...
    setupNavigations(transitions) {
      ...
      (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(t => Object.assign(Object.assign({}, t), {
...
let RouterLinkActive = /*#__PURE__*/(() => {
  class RouterLinkActive {
    ...
    isLinkActive(router) {
      const options = 'paths' in this.routerLinkActiveOptions ? this.routerLinkActiveOptions : this.routerLinkActiveOptions.exact || false;
...
let RouterPreloader = /*#__PURE__*/(() => {
  class RouterPreloader {
    ...
    processRoutes(ngModule, routes) {
      ...
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.from)(res).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.mergeAll)(), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(_ => void 0));
    }
    ...
    preloadConfig(ngModule, route) {
      return this.preloadingStrategy.preload(route, () => {
        ...
        return loaded$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.mergeMap)(config => {
...
const ROUTER_CONFIGURATION = /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_1__.InjectionToken('ROUTER_CONFIGURATION');
/**
 * @docsNotRequired
 */

const ROUTER_FORROOT_GUARD = /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_1__.InjectionToken('ROUTER_FORROOT_GUARD');
const ɵ0 = {
  enableTracing: false
};
const ROUTER_PROVIDERS = [_angular_common__WEBPACK_IMPORTED_MODULE_0__.Location, {
  ...
  deps: [UrlSerializer, ChildrenOutletContexts, _angular_common__WEBPACK_IMPORTED_MODULE_0__.Location, _angular_core__WEBPACK_IMPORTED_MODULE_1__.Injector, _angular_core__WEBPACK_IMPORTED_MODULE_1__.NgModuleFactoryLoader, _angular_core__WEBPACK_IMPORTED_MODULE_1__.Compiler, ROUTES, ROUTER_CONFIGURATION, [UrlHandlingStrategy, /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_1__.Optional()], [RouteReuseStrategy, /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_1__.Optional()]]
...
const ROUTER_INITIALIZER = /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_1__.InjectionToken('Router Initializer');
...
//# sourceMappingURL=node_modules_angular_router_fesm2015_router_js-_58ac0-es2015.c678caa6088f32c64a9e.js.map