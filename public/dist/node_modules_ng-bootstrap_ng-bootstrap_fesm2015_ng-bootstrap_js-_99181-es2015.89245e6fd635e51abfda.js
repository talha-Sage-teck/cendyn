"use strict";
(self["webpackChunkshell"] = self["webpackChunkshell"] || []).push([["node_modules_ng-bootstrap_ng-bootstrap_fesm2015_ng-bootstrap_js-_99181"],{
...
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/forms */ 25864);
...
const ngbRunTransition = (zone, element, startFn, options) => {
  ...
  const stop$ = transition$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.endWith)(true));
  ...
  zone.runOutsideAngular(() => {
    const transitionEnd$ = (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.fromEvent)(element, 'transitionend').pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.takeUntil)(stop$), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.filter)(({
      target
    }) => target === element));
    const timer$ = (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.timer)(transitionDurationMs + transitionTimerDelayMs).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.takeUntil)(stop$));
    (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.race)(timer$, transitionEnd$, finishTransition$).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.takeUntil)(stop$)).subscribe(() => {
      runningTransitions.delete(element);
      zone.run(() => {
        endFn();
        transition$.next();
  ...
  class NgbCarousel {
    ...
    ngAfterContentInit() {
      ...
      if ((0,_angular_common__WEBPACK_IMPORTED_MODULE_1__.isPlatformBrowser)(this._platformId)) {
        this._ngZone.runOutsideAngular(() => {
          const hasNextSlide$ = (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.combineLatest)([this.slide.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(slideEvent => slideEvent.current), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.startWith)(this.activeId)), this._wrap$, this.slides.changes.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.startWith)(null))]).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(([currentSlideId, wrap]) => {
          ...
          (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.combineLatest)([this._pause$, this._pauseOnHover$, this._mouseHover$, this._pauseOnFocus$, this._focused$, this._interval$, hasNextSlide$]).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(([pause, pauseOnHover, mouseHover, pauseOnFocus, focused, interval, hasNextSlide]) => pause || pauseOnHover && mouseHover || pauseOnFocus && focused || !hasNextSlide ? 0 : interval), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.distinctUntilChanged)(), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.switchMap)(interval => interval > 0 ? (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.timer)(interval, interval) : rxjs__WEBPACK_IMPORTED_MODULE_2__.NEVER), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.takeUntil)(this._destroy$)).subscribe(() => this._ngZone.run(() => this.next(NgbSlideEventSource.TIMER)));
        });
      }

      this.slides.changes.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.takeUntil)(this._destroy$)).subscribe(() => {
        var _a;
    ...
    _cycleToSelected(slideIdx, direction, source) {
      ...
      if (selectedSlide && selectedSlide.id !== this.activeId) {
        ...
        (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.zip)(...transitions).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.take)(1)).subscribe(() => {
          this._transitionIds = null;
          this.slid.emit({
            prev: previousId,
            current: selectedSlide.id,
...
let NgbDatepickerI18nDefault = /*#__PURE__*/(() => {
  class NgbDatepickerI18nDefault extends NgbDatepickerI18n {
    ...
    getWeekdayLabel(weekday, width) {
      const weekdaysStartingOnSunday = (0,_angular_common__WEBPACK_IMPORTED_MODULE_1__.getLocaleDayNames)(this._locale, _angular_common__WEBPACK_IMPORTED_MODULE_1__.FormStyle.Standalone, width === undefined ? _angular_common__WEBPACK_IMPORTED_MODULE_1__.TranslationWidth.Short : width);
...
let NgbDatepickerService = /*#__PURE__*/(() => {
  class NgbDatepickerService {
    ...
    get model$() {
      return this._model$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.filter)(model => model.months.length > 0));
    }

    get dateSelect$() {
      return this._dateSelect$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.filter)(date => date !== null));
    }
...
let NgbDatepicker = /*#__PURE__*/(() => {
  class NgbDatepicker {
    constructor(_service, _calendar, i18n, config, cd, _elementRef, _ngbDateAdapter, _ngZone) {
      ...
      _service.dateSelect$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.takeUntil)(this._destroyed$)).subscribe(date => {
        this.dateSelect.emit(date);
      });

      _service.model$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.takeUntil)(this._destroyed$)).subscribe(model => {
    ...
    focus() {
      this._ngZone.onStable.asObservable().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.take)(1)).subscribe(() => {
    ...
    ngAfterViewInit() {
      this._ngZone.runOutsideAngular(() => {
        const focusIns$ = (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.fromEvent)(this._contentEl.nativeElement, 'focusin');
        const focusOuts$ = (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.fromEvent)(this._contentEl.nativeElement, 'focusout');
        const {
          nativeElement
        } = this._elementRef; // we're changing 'focusVisible' only when entering or leaving months view
        // and ignoring all focus events where both 'target' and 'related' target are day cells

        (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.merge)(focusIns$, focusOuts$).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.filter)(({
          target,
          relatedTarget
        }) => !(hasClassName(target, 'ngb-dp-day') && hasClassName(relatedTarget, 'ngb-dp-day') && nativeElement.contains(target) && nativeElement.contains(relatedTarget))), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.takeUntil)(this._destroyed$)).subscribe(({
          type
...
function ngbAutoClose(zone, document, type, close, closed$, insideElements, ignoreElements, insideSelector) {
  ...
  if (type) {
    zone.runOutsideAngular(wrapAsyncForMobile(() => {
      ...
      const escapes$ = (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.fromEvent)(document, 'keydown').pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.takeUntil)(closed$), // tslint:disable-next-line:deprecation
      (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.filter)(e => e.which === Key.Escape), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.tap)(e => e.preventDefault())); // we have to pre-calculate 'shouldCloseOnClick' on 'mousedown',
      // because on 'mouseup' DOM nodes might be detached

      const mouseDowns$ = (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.fromEvent)(document, 'mousedown').pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(shouldCloseOnClick), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.takeUntil)(closed$));
      const closeableClicks$ = (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.fromEvent)(document, 'mouseup').pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.withLatestFrom)(mouseDowns$), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.filter)(([_, shouldClose]) => shouldClose), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.delay)(0), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.takeUntil)(closed$));
      (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.race)([escapes$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(_ => 0
      /* ESCAPE */
      )), closeableClicks$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(_ => 1
      /* CLICK */
...
const ngbFocusTrap = (zone, element, stopFocusTrap$, refocusOnClick = false) => {
  zone.runOutsideAngular(() => {
    ...
    const lastFocusedElement$ = (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.fromEvent)(element, 'focusin').pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.takeUntil)(stopFocusTrap$), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(e => e.target)); // 'tab' / 'shift+tab' stream
    ...
    (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.filter)(e => e.which === Key.Tab), // tslint:enable:deprecation
    (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.withLatestFrom)(lastFocusedElement$)).subscribe(([tabEvent, focusedElement]) => {
    ...
    if (refocusOnClick) {
      (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.fromEvent)(element, 'click').pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.takeUntil)(stopFocusTrap$), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.withLatestFrom)(lastFocusedElement$), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(arr => arr[1])).subscribe(lastFocusedElement => lastFocusedElement.focus());
    }
  });
}; // previous version:
    ...
    onKeyDown(event) {
      ...
      if (key === Key.Space || key === Key.Enter) {
        if (itemElement && (this.autoClose === true || this.autoClose === 'inside')) {
          ...
          (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.fromEvent)(itemElement, 'click').pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.take)(1)).subscribe(() => this.close());
        }
      ...
      if (key === Key.Tab) {
        if (event.target && this.isOpen() && this.autoClose) {
          if (this._anchor.nativeElement === event.target) {
            ...
            (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.fromEvent)(event.target, 'focusout').pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.take)(1)).subscribe(({
              relatedTarget
            }) => {
...
class PopupService {
  ...
  open(content, context, animation = false) {
    ...
    const transition$ = this._ngZone.onStable.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.take)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.mergeMap)(() => ngbRunTransition(this._ngZone, nativeElement, ({
      classList
    }) => classList.add('show'), {
      animation,
      runningTransition: 'continue'
...
let NgbModalBackdrop = /*#__PURE__*/(() => {
  class NgbModalBackdrop {
    ...
    ngOnInit() {
      this._zone.onStable.asObservable().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.take)(1)).subscribe(() => {
...
class NgbModalRef {
  ...
  _removeModalElements() {
    ...
    const backdropTransition$ = this._backdropCmptRef ? this._backdropCmptRef.instance.hide() : (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.of)(undefined); // hiding window
    ...
    (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.zip)(windowTransition$, backdropTransition$).subscribe(() => {
      this._hidden.next();
...
let NgbModalWindow = /*#__PURE__*/(() => {
  class NgbModalWindow {
    ...
    hide() {
      ...
      const transitions$ = (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.zip)(windowTransition$, dialogTransition$);
    ...
    _show() {
      ...
      const dialogTransition$ = ngbRunTransition(this._zone, this._dialogEl.nativeElement, () => {}, context);
      (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.zip)(windowTransition$, dialogTransition$).subscribe(() => {
        this.shown.next();
        this.shown.complete();
      });
    ...
    _enableEventHandling() {
      ...
      this._zone.runOutsideAngular(() => {
        (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.fromEvent)(nativeElement, 'keydown').pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.takeUntil)(this._closed$), // tslint:disable-next-line:deprecation
        (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.filter)(e => e.which === Key.Escape)).subscribe(event => {
          if (this.keyboard) {
        ...
        (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.fromEvent)(this._dialogEl.nativeElement, 'mousedown').pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.takeUntil)(this._closed$), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.tap)(() => preventClose = false), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.switchMap)(() => (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.fromEvent)(nativeElement, 'mouseup').pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.takeUntil)(this._closed$), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.take)(1))), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.filter)(({
          target
        ...
        (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.fromEvent)(nativeElement, 'click').pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.takeUntil)(this._closed$)).subscribe(({
          target
        }) => {
...
let NgbNav = /*#__PURE__*/(() => {
  class NgbNav {
    ...
    ngAfterContentInit() {
      ...
      this.items.changes.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.takeUntil)(this.destroy$)).subscribe(() => this._notifyItemChanged(this.activeId));
    }
...
const delayOrNoop = time => time > 0 ? (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.delay)(time) : a => a;
...
function triggerDelay(openDelay, closeDelay, isOpenedFn) {
  return input$ => {
    let pending = null;
    const filteredInput$ = input$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(open => ({
      open
    })), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.filter)(event => {
    ...
    const delayedOpen$ = filteredInput$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.filter)(event => event.open), delayOrNoop(openDelay));
    const delayedClose$ = filteredInput$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.filter)(event => !event.open), delayOrNoop(closeDelay));
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.merge)(delayedOpen$, delayedClose$).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.filter)(event => {
      if (event === pending) {
        pending = null;
      ...
      return false;
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(event => event.open));
  };
}
...
let NgbTypeahead = /*#__PURE__*/(() => {
  class NgbTypeahead {
    constructor(_elementRef, viewContainerRef, _renderer, injector, componentFactoryResolver, config, ngZone, _live, _document, _ngZone, _changeDetector, applicationRef) {
      ...
      this.placement = config.placement;
      this._valueChanges = (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.fromEvent)(_elementRef.nativeElement, 'input').pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)($event => $event.target.value));
    ...
    _subscribeToUserInput() {
      const results$ = this._valueChanges.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.tap)(value => {
        this._inputValueBackup = this.showHint ? value : null;

        this._onChange(this.editable ? value : undefined);
      }), this.ngbTypeahead ? this.ngbTypeahead : () => (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.of)([]));

      this._subscription = this._resubscribeTypeahead.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.switchMap)(() => results$)).subscribe(results => {
...
//# sourceMappingURL=node_modules_ng-bootstrap_ng-bootstrap_fesm2015_ng-bootstrap_js-_99181-es2015.89245e6fd635e51abfda.js.map