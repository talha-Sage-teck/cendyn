...
import {BaseEnumComponent, LanguageStore, DataTypeFormatter, FieldLogicManager} from 'core';
import {TagModel} from "ngx-chips/core/accessor";

@Component({
    selector: 'scrm-override-enum-edit',
    templateUrl: './override-enum.component.html',
    styleUrls: []
})
export class OverrideEnumEditFieldComponent extends BaseEnumComponent {
