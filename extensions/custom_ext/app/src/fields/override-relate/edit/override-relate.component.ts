...
import {
    ...
    DataTypeFormatter,
    FieldLogicManager,
    LanguageStore, MessageModalComponent,
    ModuleNameMapper, RecordListModalComponent, RecordListModalResult,
    RelateService
} from "core";
import {TagModel} from "ngx-chips/core/accessor";

@Component({
    selector: 'scrm-override-relate-edit',
    templateUrl: './override-relate.component.html',
    styleUrls: [],
    providers: [RelateService]
})
export class OverrideRelateEditFieldComponent extends BaseRelateComponent {
