...
import {OverrideRecordContainerComponent} from './record-container.component';
...
describe('RecordContainerComponent', () => {
    let component: OverrideRecordContainerComponent;
    let fixture: ComponentFixture<OverrideRecordContainerComponent>;
    ...
    beforeEach(waitForAsync(() => {
        TestBed.configureTestingModule({
            ...
            declarations: [OverrideRecordContainerComponent]
        })
            .compileComponents();
    }));

    beforeEach(() => {
        fixture = TestBed.createComponent(OverrideRecordContainerComponent);
