...
import {ModuleNameMapper, ActionNameMapper, MessageModalComponent} from 'core';

@Injectable({
    providedIn: 'root'
})
export class CancelCreateAction extends OverrideRecordActionHandler {
    ...
    protected cancel(data: OverrideRecordActionData): void {
    ...
    protected showConfirmationModal(data: OverrideRecordActionData): void {
