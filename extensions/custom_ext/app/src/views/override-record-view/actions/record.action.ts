...
export interface OverrideRecordActionData extends ActionData {
    store: CustomRecordViewStore;
    action?: Action;
}

export abstract class OverrideRecordActionHandler extends ActionHandler<OverrideRecordActionData> {

    abstract run(data: OverrideRecordActionData): void;

    abstract shouldDisplay(data: OverrideRecordActionData): boolean;

    checkRecordAccess(data: OverrideRecordActionData, defaultAcls: string[] = []): boolean {
