...
import {OverrideRecordActionData} from './record.action';
...
import {BaseActionManager} from 'core';
import {AsyncProcessRecordAction} from './async-process/async-process.service';

@Injectable({
    providedIn: 'root',
})
export class OverrideRecordActionManager extends BaseActionManager<OverrideRecordActionData> {
