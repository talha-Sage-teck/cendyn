...
import {
    AsyncActionInput,
    AsyncActionService,
    BaseRecordActionsAdapter, ConfirmationModalService,
    LanguageStore,
    MessageService,
    MetadataStore, Process,
    SelectModalService
} from 'core';
...
@Injectable()
export class OverrideRecordActionsAdapter extends BaseRecordActionsAdapter<OverrideRecordActionData> {
    ...
    constructor(
        ...
        protected actionManager: OverrideRecordActionManager,
    ...
    protected buildActionData(action: Action, context?: ActionContext): OverrideRecordActionData {
        return {
            store: this.store,
            action: action
        } as OverrideRecordActionData;
    }
