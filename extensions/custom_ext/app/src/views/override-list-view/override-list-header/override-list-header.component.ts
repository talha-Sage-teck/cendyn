...
import {FilterAdapter, ListViewStore, ModuleNavigation, RecordPanelAdapter, RecordPanelConfig} from "core";

@Component({
    selector: 'scrm-override-list-header',
    templateUrl: 'override-list-header.component.html',
    providers: [FilterAdapter, RecordPanelAdapter],
})
export class OverrideListHeaderComponent implements OnInit, OnDestroy {
