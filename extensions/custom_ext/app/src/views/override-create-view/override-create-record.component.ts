...
import {AppStateStore, RecordViewModel} from "core";

@Component({
    selector: 'scrm-override-create-record',
    templateUrl: './override-create-record.component.html',
    styleUrls: [],
    providers: [
        CreateViewStore,
        {
            provide: CustomRecordViewStore,
            useExisting: CreateViewStore
        }
    ]
})
export class OverrideCreateRecordComponent implements OnInit, OnDestroy {
