...
namespace App\Extension\custom_ext\modules\Opportunities\Statistics;
...
class CustomOpportunitiesBySalesStagePipeline extends LegacyHandler implements StatisticsProviderInterface
{
    use StatisticsHandlingTrait;

    public const KEY = 'custom-opportunities-by-sales-stage-price';
    ...
    protected function generateQuery(array $query): array
    {
        ...
        $query['order_by'] = '';
        $query['group_by'] = ' GROUP BY opportunities.sales_stage ORDER BY opportunities.sales_stage DESC';
