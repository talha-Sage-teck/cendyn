...
import {MultiRelateEditFieldModule} from './multirelate.module';
...
class MultiRelateEditFieldTestHostComponent {
    @ViewChild('multirelate') relate: MultiRelateEditFieldComponent;
    field: Field = {
        type: 'multrelate',
...
describe('MultiRelateRecordEditFieldComponent', () => {
    let testHostComponent: MultiRelateEditFieldTestHostComponent;
    let testHostFixture: ComponentFixture<MultiRelateEditFieldTestHostComponent>;

    beforeEach(waitForAsync(() => {
        TestBed.configureTestingModule({
            declarations: [
                MultiRelateEditFieldTestHostComponent,
            ],
            imports: [
                RouterTestingModule,
        ...
        testHostFixture = TestBed.createComponent(MultiRelateEditFieldTestHostComponent);
    ...
    it('should have select button', async () => {
        ...
        const field = testHostFixture.nativeElement.getElementsByTagName('scrm-multirelate-edit')[0];
