...
import {MultiRelateService} from '../../../../services/record/multirelate/multirelate.service';
...
@Component({
    selector: 'scrm-multirelate-filter',
    templateUrl: './multirelate.component.html',
    styleUrls: [],
    providers: [MultiRelateService]
})
export class MultiRelateFilterFieldComponent extends BaseRelateComponent {
