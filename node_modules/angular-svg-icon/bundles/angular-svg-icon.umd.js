(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common/http'),require('@angular/common'),exports, require('@angular/core'), require('@angular/common'), require('rxjs'), require('rxjs/operators'), require('@angular/common/http')) :
    typeof define === 'function' && define.amd ? define('angular-svg-icon', ['@angular/core','@angular/common/http','@angular/common','exports', '@angular/core', '@angular/common', 'rxjs', 'rxjs/operators', '@angular/common/http'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ng.common.http,global.ng.common,global['angular-svg-icon'] = {}, global.ng.core, global.ng.common, global.rxjs, global.rxjs.operators, global.ng.common.http));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,exports, core, common, rxjs, operators, http) { 
var _c0 = ["*"];
'use strict';
...
SvgHttpLoader.ɵprov = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjectable({ token: SvgHttpLoader, factory: function (t) { return SvgHttpLoader.ɵfac(t); } });
...
SvgIconRegistryService.ɵfac = function SvgIconRegistryService_Factory(t) { return new (t || SvgIconRegistryService)(ɵngcc0.ɵɵinject(SvgLoader), ɵngcc0.ɵɵinject(core.PLATFORM_ID), ɵngcc0.ɵɵinject(SERVER_URL, 8), ɵngcc0.ɵɵinject(common.DOCUMENT, 8)); };
SvgIconRegistryService.ɵprov = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjectable({ token: SvgIconRegistryService, factory: function (t) { return SvgIconRegistryService.ɵfac(t); } });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(SvgIconRegistryService, [{
    ...
    SvgIconRegistryService.ctorParameters = function () { return [
        ...
        { type: undefined, decorators: [{ type: core.Optional }, { type: core.Inject, args: [SERVER_URL,] }] },
    ...
    var SvgIconHelper = /** @class */ (function () {
        function SvgIconHelper() {
            this.loaded = false;
        }
        return SvgIconHelper;
    }());
    var SvgIconComponent = /** @class */ (function () {
        ...
        SvgIconComponent.prototype.init = function () {
            ...
            if (this.name) {
                ...
                if (svgObs) {
                    this.helper.icnSub = svgObs.subscribe(function (svg) { return _this.initSvg(svg); });
                }
            }
            else if (this.src) {
                var svgObs = this.iconReg.loadSvg(this.src);
                if (svgObs) {
                    this.helper.icnSub = svgObs.subscribe(function (svg) { return _this.initSvg(svg); });
                }
            }
        ...
        SvgIconComponent.prototype.setClass = function (target, previous, current) {
            var e_1, _a, e_2, _b;
            if (target) {
                if (previous) {
                ...
                if (current) {
                    var klasses = Array.isArray(current) ? current : current.split(' ');
                    try {
                        for (var klasses_2 = __values(klasses), klasses_2_1 = klasses_2.next(); !klasses_2_1.done; klasses_2_1 = klasses_2.next()) {
                            var k = klasses_2_1.value;
                        ...
                        try {
                            if (klasses_2_1 && !klasses_2_1.done && (_b = klasses_2.return)) _b.call(klasses_2);
                        }
        ...
        SvgIconComponent.prototype.doAria = function (label) {
            var svg = this.element.nativeElement.firstChild;
            if (svg) {
                if (label === '') {
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(AngularSvgIconModule, { declarations: [SvgIconComponent], imports: [ɵngcc2.CommonModule], exports: [SvgIconComponent] }); })();
