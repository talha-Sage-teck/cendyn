(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['ng-animate'] = {}, global.ng.animations));
    ...
    var flash = animations.animation(animations.animate('{{ timing }}s {{ delay }}s', animations.keyframes([
    ...
    var pulse = animations.animation(animations.animate('{{ timing }}s {{ delay }}s', animations.keyframes([
    ...
    var rubberBand = animations.animation(animations.animate('{{ timing }}s {{ delay }}s', animations.keyframes([
    ...
    var swing = animations.animation(animations.animate('{{ timing }}s {{ delay }}s', animations.keyframes([
    ...
    var tada = animations.animation(animations.animate('{{ timing }}s {{ delay }}s', animations.keyframes([
        animations.style({ transform: 'scale3d(1, 1, 1)', offset: 0 }),
        animations.style({
    ...
    var wobble = animations.animation(animations.animate('{{ timing }}s {{ delay }}s', animations.keyframes([
    ...
    var jello = animations.animation(animations.animate('{{ timing }}s {{ delay }}s', animations.keyframes([
        animations.style({ transform: 'none', offset: 0 }),
    ...
    var bounceIn = animations.animation(animations.animate('{{ timing }}s {{ delay }}s cubic-bezier(0.215, 0.610, 0.355, 1.000)', animations.keyframes([
    ...
    var bounceOut = animations.animation(animations.animate('{{ timing }}s {{ delay }}s', animations.keyframes([
    ...
    var fadeOutDown = fadeOutY('-100%', 0);
    var fadeOutUp = fadeOutY('100%', 0);
    var fadeOutLeft = fadeOutX('-100%', 0);
    var fadeOutRight = fadeOutX('100%', 0);
    function slideX(a, b) {
        return animations.animation(animations.animate('{{ timing }}s {{ delay }}s', animations.keyframes([
            animations.style({
                transform: 'translate3d({{ a }}, 0, 0)',
    ...
    var lightSpeedIn = animations.animation(animations.animate('{{ timing }}s {{ delay }}s', animations.keyframes([
        animations.style({
            opacity: 0,
    ...
    var lightSpeedOut = animations.animation(animations.animate('{{ timing }}s {{ delay }}s ease-out', animations.keyframes([
        animations.style({
            opacity: 1,
            offset: 0,
        }),
    ...
    var jackInTheBox = animations.animation([
        animations.animate('{{ timing }}s {{ delay }}s', animations.keyframes([
            animations.style({
                opacity: 0,
    ...
    var zoomIn = animations.animation([
        animations.animate('{{ timing }}s {{ delay }}s', animations.keyframes([
            animations.style({
                opacity: 0,
    ...
    var zoomOut = animations.animation([
        animations.animate('{{ timing }}s {{ delay }}s', animations.keyframes([
            animations.style({
                opacity: 1,
                offset: 0
...
//# sourceMappingURL=ng-animate.umd.js.map