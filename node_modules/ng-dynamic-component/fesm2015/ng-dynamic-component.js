import { InjectionToken, Directive, Host, NgModule, SimpleChange, ChangeDetectorRef, Injectable, KeyValueDiffers, ComponentFactoryResolver, Inject, Optional, Input, EventEmitter, Injector, Component, ViewContainerRef, Output, Renderer2, ɵɵdefineInjectable, ɵɵinject, INJECTOR, ElementRef, IterableDiffers } from '@angular/core';
...
ComponentOutletInjectorModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ imports: [[CommonModule]] });
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(ComponentOutletInjectorModule, { declarations: function () { return [ComponentOutletInjectorDirective]; }, imports: function () { return [CommonModule]; }, exports: function () { return [ComponentOutletInjectorDirective]; } }); })();
...
DynamicModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ imports: [[CommonModule, DynamicIoModule], DynamicIoModule] });
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(DynamicModule, { declarations: function () { return [DynamicComponent]; }, imports: function () { return [CommonModule, DynamicIoModule]; }, exports: function () { return [DynamicComponent, DynamicIoModule]; } }); })();
...
/** @nocollapse */ IoFactoryService.ɵprov = ɵɵdefineInjectable({ factory: function IoFactoryService_Factory() { return new IoFactoryService(ɵɵinject(KeyValueDiffers), ɵɵinject(ComponentFactoryResolver), ɵɵinject(EventArgumentToken)); }, token: IoFactoryService, providedIn: "root" });
...
/** @nocollapse */ WindowRefService.ɵprov = ɵɵdefineInjectable({ factory: function WindowRefService_Factory() { return new WindowRefService(ɵɵinject(INJECTOR)); }, token: WindowRefService, providedIn: "root" });
...
DynamicDirectivesModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ imports: [[CommonModule], ComponentOutletInjectorModule] });
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(DynamicDirectivesModule, { declarations: function () { return [DynamicDirectivesDirective]; }, imports: function () { return [CommonModule]; }, exports: function () { return [DynamicDirectivesDirective, ComponentOutletInjectorModule]; } }); })();
