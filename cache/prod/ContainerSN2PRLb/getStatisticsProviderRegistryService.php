...
class getStatisticsProviderRegistryService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['App\\Statistics\\Service\\StatisticsProviderRegistry'] = new \App\Statistics\Service\StatisticsProviderRegistry(new RewindableGenerator(function () use ($container) {
            ...
            yield 26 => ($container->privates['App\\Module\\cb2b_production_summary_data\\Statistics\\Subpanels\\SubPanelcb2b_production_summary_dataTotal'] ?? $container->load('getSubPanelcb2bProductionSummaryDataTotalService'));
            yield 27 => ($container->privates['App\\Extension\\custom_ext\\modules\\Opportunities\\Statistics\\CustomOpportunitiesBySalesStagePipeline'] ?? $container->load('getCustomOpportunitiesBySalesStagePipelineService'));
        }, 28));
    }
}
