...
class getProcessDataPersisterService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['App\\Process\\DataPersister\\ProcessDataPersister'] = new \App\Process\DataPersister\ProcessDataPersister(new \App\Process\Service\ProcessHandlerRegistry(new RewindableGenerator(function () use ($container) {
            ...
            yield 23 => ($container->privates['App\\UserPreferences\\LegacyHandler\\SaveUiPreferences'] ?? $container->load('getSaveUiPreferencesService'));
            yield 24 => ($container->privates['App\\Extension\\custom_ext\\modules\\CB2B_PMSProfiles\\Service\\ConvertPMSProfileAction'] ?? $container->load('getConvertPMSProfileActionService'));
        }, 25)), ($container->privates['security.helper'] ?? $container->load('getSecurity_HelperService')));
    }
}
